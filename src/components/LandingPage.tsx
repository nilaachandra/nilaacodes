...
const LandingPage = () => {
  return (
    <section className="w-full">
      ...
      <button className="flex gap-2 h-9 items-center bg-blue-800 text-white dark:bg-white hover:opacity-90 dark:text-black px-2.5 font-semibold mt-6 rounded-md">
